...
{
    public class Pieczarki : Dodatek
    {
        PizzaBazowa pizza;
        public Pieczarki(PizzaBazowa pizza) { this.pizza = pizza; UzupelnijDane(pizza); }
        public override decimal GetCena() { pizza.stan = this.stan; return pizza.GetCena() + 3; }
        public override string GetOpis() { return pizza.GetOpis() + ", pieczarki"; }
